...
- **Overview Dashboard** — A summary of all Radius resources in the cluster with status breakdowns (succeeded, failed, processing, suspended).
  ...
  {{< image src="images/radius_overview.png" alt="screenshot of the Azure portal showing the ACI environment created by Radius" width=600 >}}
...
- **Applications** — Lists all Radius applications, with detail views showing environment configuration, associated resources, and system metadata.
  ...
  {{< image src="images/app_detail.png" alt="screenshot of the Azure portal showing the ACI environment created by Radius" width=600 >}}
  
- **Environments** — Browse Radius environments and their compute configuration.

  {{< image src="images/environments.png" alt="screenshot of the Azure portal showing the ACI environment created by Radius" width=600 >}}
...
- **Resources** — View resources across all Radius providers (`Applications.Core`, `Applications.Datastores`, `Applications.Messaging`, `Applications.Dapr`) with provisioning state indicators.
  ...
  {{< image src="images/resources.png" alt="screenshot of the Azure portal showing the ACI environment created by Radius" width=600 >}}
...
- **Resource Types** — Explore the Radius resource types registered in your cluster, including API versions, schemas, and properties.
  ...
  {{< image src="images/rt_details.png" alt="screenshot of the Azure portal showing the ACI environment created by Radius" width=600 >}}
...
{{< image src="images/headlamp_plugin.png" alt="screenshot of the Azure portal showing the ACI environment created by Radius" width=600 >}}
