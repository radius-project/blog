...
After the launch of Radius on October 18, 2023, we received a lot of positive feedback about the project, how the problem space that Radius was trying to solve resonated with the cloud native technologists. Our launch at Linux Foundation Member summit and our presentation at Ignite created awareness about Radius to the different communities of developers, open-source enthusiasts and enterprise decision makers. We received a lot of feedback and ideas on how we could make Radius work for enterprise scenarios and how Radius works with other cloud native technologies. Community members started contributing to Radius picking up simple good-first-issues to more in-depth features.
