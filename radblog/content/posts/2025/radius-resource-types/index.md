...
{{< image src="images/vscode.png" alt="Screenshot of VS Code showing Intellisense type ahead assistance with Radius Resource Types" width="70%">}}
...
{{< image src="images/openai.png" alt="Diagram showing the OpenAI resource type schema for developers separate from the Environment and Recipe" width="70%" >}}
...
{{< image src="images/composite.png" alt="Diagram showing the web service resource type being created by a composite Recipe with two resources implemented by a Terraform and Bicep recipe" width="70%" >}}
