...
Currently, ACI support is hardcoded as imperative Go code in the Radius core codebase, including the API, Recipes, data model, and other components. The Environment and Container resource schemas were updated to include ACI-specific properties. If you're interested in diving deeper into the implementation details, you can refer to the code changes in [PR #9436](https://github.com/radius-project/radius/pull/9436).
